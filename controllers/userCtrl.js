...
const userCtrl = {
    register: async (req, res) =>{
        try {
            ...
            if (password !== cfpassword)
                return res.status(400).json({msg: "Incorrect confirm password!"})
            // Password Encryption
            ...
            res.json({msg:"Register successful.Login now!"})
    ...
    forgot: async (req, res) =>{
        try {
            ...
            res.json({msg: "We've sent an email to help you.Check it out!"})
